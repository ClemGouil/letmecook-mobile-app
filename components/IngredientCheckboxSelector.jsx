...
const IngredientCheckboxSelector = ({ title, items, selectedIngredients, serving, toggleAll, isSelected, toggleSelection, getScaledQuantity, onIncrease, onDecrease }) => {
...
export default IngredientCheckboxSelector;